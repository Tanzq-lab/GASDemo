...
namespace AlsOverlayModeTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(NonPistol, FName{TEXTVIEW("Als.OverlayMode.NonPistol")})
	UE_DEFINE_GAMEPLAY_TAG(NonPistol_Rifle, FName{TEXTVIEW("Als.OverlayMode.NonPistol.Rifle")})
	UE_DEFINE_GAMEPLAY_TAG(NonPistol_RocketLauncher, FName{TEXTVIEW("Als.OverlayMode.NonPistol.RocketLauncher")})
	UE_DEFINE_GAMEPLAY_TAG(NonPistol_Shotgun, FName{TEXTVIEW("Als.OverlayMode.NonPistol.Shotgun")})
...
namespace AlsLocomotionActionTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(WeaponReload, FName{TEXTVIEW("Als.LocomotionAction.WeaponReload")})
}
