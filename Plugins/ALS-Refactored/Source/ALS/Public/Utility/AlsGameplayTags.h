...
namespace AlsOverlayModeTags
{
	...
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(NonPistol)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(NonPistol_Rifle)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(NonPistol_RocketLauncher)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(NonPistol_Shotgun)
...
namespace AlsLocomotionActionTags
{
	...
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(WeaponReload)
}
